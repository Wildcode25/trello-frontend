...
export const ListForm = ({setFocus, isFocused}:Props)=>{
    ...
    }} value={listData.name} name='name' onChange={handleChangeListData} type="text" autoFocus={true} className="w-56 rounded-sm focus:outline-blue-600  border-2 border-gray-400" />
    <div className="">
