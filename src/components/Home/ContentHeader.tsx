...
export const Header = ()=>{
    ...
    return <header className={` row-start-1 min-h-max md:row-span-1  col-start-2 bg-gradient-to-l from-${board?.color}-800 to-${board?.color}-800  py-3 flex flex-col md:flex-row items-center justify-between `}>
    ...
    <button className="md:text-black p-[6px] px-[10px] flex md:bg-slate-200 rounded-sm text-sm"><i className="scale-75 fi fi-br-bars-filter mr-2"></i> Tableros</button>
    <i className="fi scale-75 fi-br-angle-down"></i>
    </div>
    </div>
    <div className="flex gap-8 px-6 items-center justify-end w-full">
